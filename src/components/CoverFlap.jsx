    ...
    return (
        <div className="relative w-full h-full flex flex-col items-center justify-center gap-4 sm:gap-6 md:flex-row md:gap-16 p-4 sm:p-6 md:p-12 lg:p-16 overflow-hidden">
            ...
            <div className="relative flex-shrink-0">
                ...
                <div
                    ...
                    style={{
                        ...
                        paddingBottom: 'clamp(24px, 8vw, 56px)',
                        borderRadius: '6px',
                ...
                >
                    <img
                        ...
                        style={{
                            display: 'block',
                            width: 'clamp(100px, min(30vw, 40vh), 240px)',
                            height: 'clamp(100px, min(30vw, 40vh), 240px)',
                            objectFit: 'cover',
            ...
            <div className="absolute bottom-3 left-3 sm:bottom-6 sm:left-6 md:bottom-14 md:left-16 lg:bottom-16 lg:left-24">
                <div style={{
                    width: 'clamp(60px, min(16vw, 25vh), 130px)',
                    height: 'clamp(60px, min(16vw, 25vh), 130px)',
                    borderRadius: '50%',
                    ...
                    <span style={{ fontSize: 'clamp(0.25rem, min(0.9vw, 1.5vh), 0.5rem)', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>Computer Science Student</span>
                    <span style={{ fontSize: 'clamp(0.5rem, min(2vw, 3.5vh), 1.3rem)', fontWeight: 900, lineHeight: 1.1 }}>INTERN READY</span>
                    <span style={{ fontSize: 'clamp(0.25rem, min(0.9vw, 1.5vh), 0.5rem)', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase' }}>Class of 2026</span>
                </div>
            </div>
        </div>
    );
